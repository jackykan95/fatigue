...
public class ActivitiesWeekly extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_activities_weekly);
        ...
        LifeLog.checkAuthentication(ActivitiesWeekly.this, new LifeLog.OnAuthenticationChecked() {
            @Override
            public void onAuthChecked(boolean authenticated) {
                if (authenticated) {
                    ...
                    LifeLog.doLogin(ActivitiesWeekly.this);
                }
            }
        });
    ...
    public void processLifeLogRequests(){
        ...
        apiUrl = apiUrl + "?start_time="+ DateHelper.getIsoDate(true,false)+"&end_time="+ DateHelper.getIsoDate(false,true);
                    ...
                    public void onResponse(JSONObject jsonObject) {
                        ...
                        try {
                            ...
                            if(!checkNoLoggedData()) {
                                ...
                                Toast.makeText(ActivitiesWeekly.this, "Cannot display the summary as no data is logged in this period", Toast.LENGTH_SHORT).show();
                            }

                        } catch (Exception e) {
                            if (Debug.isDebuggable(ActivitiesWeekly.this)) {
        ...
        VolleySingleton.getInstance(ActivitiesWeekly.this).addToRequestQueue(activitiesRequest);
    }
