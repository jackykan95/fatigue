...
public class FirebaseLoginActivity extends FragmentActivity
    ...
    private String TAG = "FirebaseLoginActivity";
    ...
    public void onConnectionFailed(ConnectionResult result) {
        Toast.makeText(this, "Cannot establish a connection with the Google service, please try again.", Toast.LENGTH_SHORT).show();
