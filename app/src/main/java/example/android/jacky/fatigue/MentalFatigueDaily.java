...
public class MentalFatigueDaily extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mental_fatigue_daily);
        ...
        mChart.setCenterText("Daily Mental Fatigue Summary");
        ...
        queryRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if(responseMap != null) {
                    ...
                    Toast.makeText(MentalFatigueDaily.this, "Cannot display the summary as no data is stored for today", Toast.LENGTH_SHORT).show();
                }
            }
