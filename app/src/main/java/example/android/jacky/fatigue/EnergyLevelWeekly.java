...
public class EnergyLevelWeekly extends AppCompatActivity {

    private PieChart mChart;

    private static String TAG = "EnergyLevelWeekly";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_energy_level_weekly);
        ...
        mChart.setCenterText("Weekly Energy Level Summary");
        ...
        queryRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if(responseMap != null) {
                    ...
                    Toast.makeText(EnergyLevelWeekly.this, "Cannot display the summary as no data is stored for the past week", Toast.LENGTH_SHORT).show();
                }
            }
