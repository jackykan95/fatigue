...
public class MentalFatigueWeekly extends AppCompatActivity {

    private PieChart mChart;

    private static String TAG = "MentalFatigueDaily";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mental_fatigue_weekly);
        ...
        mChart.setCenterText("Weekly Mental Fatigue Summary");
        ...
        DatabaseReference energyLevelRef = database.getReference("fatigueDialogResponse");

        DateHelper dateHelper = new DateHelper();

        Query queryRef = energyLevelRef.orderByKey().startAt(Long.toString(dateHelper.getWeekStartOfDayMillis()))
                .endAt(Long.toString(dateHelper.getEndOfDayMillis()));

        Log.d(TAG, "Start At: " + dateHelper.getWeekStartOfDayMillis() + "End At: " + dateHelper.getEndOfDayMillis());
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if(responseMap != null) {
                    ...
                    if (FatigueFragment.getCounter(0) != 0) {
                        entries.add(new PieEntry((FatigueFragment.getCounter(0) * 100) / (float) totalResponse, "Cannot Concentrate"));
                    }
                    ...
                    if (FatigueFragment.getCounter(10) != 0) {
                        entries.add(new PieEntry((FatigueFragment.getCounter(10) * 100) / (float) totalResponse, "Full Concentration"));
                    }

                    PieDataSet set = new PieDataSet(entries, "Mental Fatigue");
                    ...
                    Toast.makeText(MentalFatigueWeekly.this, "Cannot display the summary as no data is stored for the past week", Toast.LENGTH_SHORT).show();
                }
            }
